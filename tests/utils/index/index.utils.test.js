...
describe('utils', () => {
	...
	// it('should provide base64 string of image', async () => {
	// 	const blob = 'apple/jpg';
	...
	// 	console.log(readAsDataURL(blob));
	...
	it('should generateUID where "+/" is replaced with " "', () => {
		...
		const length = 10;
		const guid = generateUID(length);
		expect(guid).toEqual('AAAAAAAAAA');
	});
