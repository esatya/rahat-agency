    ...
    slimScroll: function (g) {
      ...
      this.each(function () {
        ...
        function m(d, e, g) {
          ...
          e &&
            ((f = parseInt(c.css("top")) + ((d * parseInt(a.wheelStep)) / 100) * c.outerHeight()),
        ...
        function w() {
          ...
          u >= b.outerHeight()
            ? (k = !0)
            : (c.stop(!0, !0).fadeIn("fast"), a.railVisible && h.stop(!0, !0).fadeIn("fast"));
        }
        function p() {
          a.alwaysVisible ||
        ...
        if (b.parent().hasClass(a.wrapperClass)) {
          ...
          n = e("<div></div>")
            ...
            .css({ position: "relative", overflow: "hidden", width: a.width, height: a.height });
          ...
          b.bind("touchmove", function (b) {
            ...
            b.originalEvent.touches.length &&
              (m((A - b.originalEvent.touches[0].pageY) / a.touchScrollStep, !0),
          ...
          "bottom" === a.start
            ...
            : "top" !== a.start &&
              (m(e(a.start).position().top, null, !0), a.alwaysVisible || c.hide());
