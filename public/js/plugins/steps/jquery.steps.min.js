...
!(function (a, b) {
  ...
  function h(a, b) {
    ...
    a.triggerHandler("finishing", [b.currentIndex])
      ? (c.addClass("done").removeClass("error"), a.triggerHandler("finished", [b.currentIndex]))
      : c.addClass("error");
  }
  function i(a) {
  ...
  function D(a, b, c) {
    if (b.enablePagination) {
      ...
      b.enableFinishButton && b.showFinishButtonAlways
        ...
        : (d._showAria(b.enableFinishButton && c.stepCount === c.currentIndex + 1),
          e
            ._showAria(0 === c.stepCount || c.stepCount > c.currentIndex + 1)
            ._enableAria(c.stepCount > c.currentIndex + 1 || !b.enableFinishButton));
    }
  }
  function E(b, c, d, e) {
  ...
  function J(b, c, d) {
    var e = '<{0} class="{1}">{2}</{0}>',
      ...
      i = a(
        e.format(c.stepsContainerTag, "steps " + c.clearFixCssClass, '<ul role="tablist"></ul>')
      ),
  ...
  function R(a) {
    throw (
      (arguments.length > 1 && (a = a.format(Array.prototype.slice.call(arguments, 1))),
      new Error(a))
    );
  }
  function S(a, b) {
  ...
  a.fn.extend({
    ...
    String.prototype.format ||
      (String.prototype.format = function () {
        for (
          var b = 1 === arguments.length && a.isArray(arguments[0]) ? arguments[0] : arguments,
            c = this,
            d = 0;
          d < b.length;
          d++
