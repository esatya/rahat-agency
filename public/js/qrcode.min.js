...
(function () {
  ...
  function g(a, b) {
    ...
    if (d > w.length) throw new Error("Too long data");
    return (
      0 != b.version &&
        (d <= b.version
          ? ((d = b.version), (b.runVersion = d))
          : (console.warn("QR Code version " + b.version + " too small, run version use " + d),
            (b.runVersion = d))),
      d
    );
  }
  ...
  (a.prototype = {
    ...
    (b.prototype = {
      ...
      setupTypeInfo: function (a, b) {
        for (
          var c = (this.errorCorrectLevel << 3) | b, d = t.getBCHTypeInfo(c), e = 0;
          e < 15;
          e++
        ) {
          var f = !a && 1 == ((d >> e) & 1);
      ...
      mapData: function (a, b) {
        for (
          var c = -1, d = this.moduleCount - 1, e = 7, f = 0, g = this.moduleCount - 1;
          g > 0;
          g -= 2
        )
          for (6 == g && g--; ; ) {
    ...
    (b.createBytes = function (a, b) {
      for (
        var d = 0, e = 0, f = 0, g = new Array(b.length), h = new Array(b.length), i = 0;
        i < b.length;
        i++
      ) {
        var j = b[i].dataCount,
  ...
  for (
    var q = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
      r = { L: 1, M: 0, Q: 3, H: 2 },
      s = {
        PATTERN000: 0,
        PATTERN001: 1,
  ...
  for (var v = 8; v < 256; v++)
    u.EXP_TABLE[v] =
      u.EXP_TABLE[v - 4] ^ u.EXP_TABLE[v - 5] ^ u.EXP_TABLE[v - 6] ^ u.EXP_TABLE[v - 8];
  ...
  (c.prototype = {
    ...
    mod: function (a) {
      ...
      for (
        var b = u.glog(this.get(0)) - u.glog(a.get(0)), d = new Array(this.getLength()), e = 0;
        e < this.getLength();
        e++
      )
        d[e] = this.get(e);
  ...
  var w = [
      ...
      return (
        (a.prototype.draw = function (a) {
          ...
          f.setAttributeNS(
            ...
            d.appendChild(f),
            f.appendChild(b("rect", { fill: c.colorLight, width: "100%", height: "100%" })),
            f.appendChild(
              b("rect", { fill: c.colorDark, width: "1", height: "1", id: "template" })
            );
          for (var g = 0; g < e; g++)
            for (var h = 0; h < e; h++)
              if (a.isDark(g, h)) {
    ...
    z = y
      ...
      ? (function () {
          function a() {
            try {
              var a = this._elCanvas.toDataURL("image/png");
              (this._elImage.src = a),
                (this.dataURL = a),
          ...
          return (
            (e.prototype.draw = function (a) {
              function b() {
                (e.lineWidth = 0),
                  (e.fillStyle = f.quietZoneColor),
                  e.fillRect(0, 0, j._elCanvas.width, f.quietZone),
                  e.fillRect(0, f.quietZone, f.quietZone, j._elCanvas.height - 2 * f.quietZone),
                  e.fillRect(
                    j._elCanvas.width - f.quietZone,
                    f.quietZone,
                    f.quietZone,
                    j._elCanvas.height - 2 * f.quietZone
                  ),
                  e.fillRect(0, j._elCanvas.height - f.quietZone, j._elCanvas.width, f.quietZone);
              }
              function c(a) {
                function c() {
                  var a = Math.round(f.width / 3.5),
                    c = Math.round(f.height / 3.5);
                  a != c && (a = c),
                    f.logoWidth && (a = Math.round(f.logoWidth)),
                    f.logoHeight && (c = Math.round(f.logoHeight)),
                    f.logoBackgroundTransparent ||
                      ((e.fillStyle = f.logoBackgroundColor),
                      e.fillRect(
                        (f.width + 2 * f.quietZone - a) / 2,
                        (f.height + f.titleHeight + 2 * f.quietZone - c) / 2,
                        a,
                        a
                      )),
                    e.drawImage(
                    ...
                    f.quietZone > 0 && f.quietZoneColor && b(),
                    (u._bIsPainted = !0),
                    u.makeImage();
                }
                f.onRenderingStart && f.onRenderingStart(f);
                for (var d = 0; d < g; d++)
                  for (var j = 0; j < g; j++) {
                    ...
                    if (n) {
                      ...
                      (e.lineWidth = 0),
                        ...
                        e.fillRect(k, f.titleHeight + l, h, i);
                    } else {
                      (e.lineWidth = 0),
                        ...
                        f.backgroundImage
                          ? (f.autoColor
                              ? ((e.strokeStyle = m
                                  ? "rgba(0, 0, 0, .6)"
                                  : "rgba(255, 255, 255, .7)"),
                                (e.fillStyle = m ? "rgba(0, 0, 0, .6)" : "rgba(255, 255, 255, .7)"))
                              : ((e.strokeStyle = m ? f.colorDark : "rgba(0,0,0,0)"),
                                (e.fillStyle = m ? f.colorDark : "rgba(0,0,0,0)"),
                                (e.strokeStyle = e.fillStyle)),
                            e.fillRect(
                              k + (h * (1 - q)) / 2,
                              f.titleHeight + l + (i * (1 - q)) / 2,
                ...
                if (
                  (f.title &&
                    ((e.fillStyle = f.titleBackgroundColor),
                    e.fillRect(0, 0, this._elCanvas.width, f.titleHeight + f.quietZone),
                    (e.font = f.titleFont),
                    (e.fillStyle = f.titleColor),
                    (e.textAlign = "center"),
                    e.fillText(f.title, this._elCanvas.width / 2, +f.quietZone + f.titleTop)),
                  f.subTitle &&
                    ((e.font = f.subTitleFont),
                    (e.fillStyle = f.subTitleColor),
                    e.fillText(f.subTitle, this._elCanvas.width / 2, +f.quietZone + f.subTitleTop)),
                  f.logo)
                ) {
                  var t = new Image(),
                    u = this;
              ...
              (f.width = h * g),
                (f.height = i * g + f.titleHeight),
                (f.quietZone = Math.round(f.quietZone)),
                (this._elCanvas.width = f.width + 2 * f.quietZone),
                (this._elCanvas.height = f.height + 2 * f.quietZone),
                (d.style.display = "none"),
                this.clear(),
                (e.lineWidth = 0),
                (e.fillStyle = f.colorLight),
                e.fillRect(0, 0, this._elCanvas.width, this._elCanvas.height);
              var j = this;
              if (f.backgroundImage) {
                var k = new Image();
                (k.onload = function () {
                  (e.globalAlpha = 1),
                    (e.globalAlpha = f.backgroundImageAlpha),
                    e.drawImage(
                      k,
                      0,
                      f.titleHeight,
                      f.width + 2 * f.quietZone,
                      f.height + 2 * f.quietZone - f.titleHeight
                    ),
                    (e.globalAlpha = 1),
                    c.call(j, a);
                }),
            ...
            (a.prototype.draw = function (a) {
              ...
              if ((g.push("</table>"), g.push("</div>"), b.logo)) {
                ...
                var w = b.width / 3.5,
                  x = b.height / 3.5;
                w != x && (w = x),
                  b.logoWidth && (w = b.logoWidth),
                  b.logoHeight && (x = b.logoHeight);
                var y =
                  "position:relative; z-index:1;display:inline-block;top:-" +
                  ((b.height - b.titleHeight) / 2 + x / 2 + b.quietZone) +
                  "px;text-align:center; width:" +
                  w +
                  "px; height:" +
                  x +
                  "px;";
                b.logoBackgroundTransparent || (y += "background:" + b.logoBackgroundColor),
                  g.push(
                    '<div style="' +
                      y +
                      '"><img  src="' +
  ...
  (j = function (a, b) {
    ...
    (j.prototype.makeCode = function (a) {
      (this._oQRCode = new b(g(a, this._htOption), this._htOption.correctLevel)),
    ...
    (j.prototype.resize = function (a, b) {
      (this._htOption.width = a), (this._htOption.height = b), this._oDrawing.draw(this._oQRCode);
    }),
